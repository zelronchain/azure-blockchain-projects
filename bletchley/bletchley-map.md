 ...
 *Translation: if you are paying for the red balloon with a check from your Mom, you have to get her to sign the check before being handed the red balloon. You are encumbered from enjoying it if you are missing the signature*
- Some token properties may be publicly visible while others require permissions or investigation.
 *Translation: if you wrote your initials on the $1 bill on the back lower left hand corner, this property would not be visibly recognizable upon initial glance. But recognizing it as a $1 bill is visibly obvious*
- Tokens are meant to be contracted. A transfer on a token will not be aware of any conditions that need to be met before completing. A token receiving a transfer request is not concerned about the external conditions in which the transfer was generated.
 *You're $1 will not jump back into your hand if the vendor hands you a deflated blue balloon.  That is up to your agreement with the seller, a verbal contract of what you ordered.*
...
Separating out Tokens from Contracts is an important concept. Limiting tokens to the set of properties and behaviors needed for a digital representation makes them more contactable.
...
Well, that is it for now, you have reached the edge of the map. There is a wealth of information available out there, now that you have context. For example, checkout the [Bletchley Map Series](https://www.youtube.com/playlist?list=PLndM9ZTRSX-Yb980yRZIoeqXy3qX9uijU) of videos, for those that would rather watch a video than read a long paper. (Perhaps we should have put this link at the top)

### Bletchley Map Episodes

- [Introduction](https://youtu.be/uU4cQKVwnOk)
- [Authenticity](https://youtu.be/JHyflxWtHaQ)
- [Properties](https://youtu.be/Cz5Df8nf7Ss)
- [Behaviors]()
- [Extra Credit]()
